# 👋 Olá, eu sou Daniel Morais

### Desenvolvedor Full Stack | React • TypeScript • Node.js • Java • Python

Sou desenvolvedor focado na construção de **aplicações web, APIs e sistemas orientados a dados**, buscando transformar problemas reais em soluções simples, escaláveis e bem estruturadas.

Atualmente trabalho principalmente com **React, TypeScript, Node.js/NestJS, Java e Python**, além de bancos de dados relacionais e ferramentas de análise de dados.
